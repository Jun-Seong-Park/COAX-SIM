function CoaX_Ani_tracking(Position, Angle, TiltAngle, i_f, dt, name)
    ...
    for i = 1:50:i_f
        ...
        xlim([Position(1,i) - camoff, Position(1,i) + camoff]);
        ylim([Position(2,i) - camoff, Position(2,i) + camoff]);
        zlim([Position(3,i) - camoff, Position(3,i) + camoff]);

        % Plot position trace
        plot3(Position(1,1:i), Position(2,1:i), Position(3,1:i), 'b--', 'LineWidth', 3);
